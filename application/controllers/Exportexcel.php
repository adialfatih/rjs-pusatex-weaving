...
public function piutang(){
    ...
    $style_row = [
      ...
      $sum_bayar = 0;
      $nomering = 5;
      //note :  mulai dari sini copas dari nota_piutang_konsumen_all.php //disamakan 
      foreach($tglar as $index => $value){
            if($jenis[$index]=="Pembelian"){
                ...
                $kredit_1 = $dtqr->row("nominal_pemb");
            ...
            $print4_1 = floatval($panjang[$index]);
            if($print4_1 > 0){ $print4_1 = $panjang[$index]; } else { $print4_1 = 0; }
            ...
            $print5_1 = floatval($harga[$index]);
            if($print5_1 > 0){ $print5_1 = $harga[$index]; } else { $print5_1 = 0; }
            if($rtx[0]=="SLD"){ $print6 = ""; $print6_1 = ""; } else { $print6 = $debet; $print6_1 = $debet1; }
            ...
            $sheet->setCellValue('E'.$nomering.'', $print4_1);
            $sheet->setCellValue('F'.$nomering.'', $print5_1);
            $sheet->setCellValue('G'.$nomering.'', $print6_1);
            $sheet->setCellValue('H'.$nomering.'', $kredit_1);
            $sheet->setCellValue('I'.$nomering.'', $print7_1);
      ...
      $sum_panjang_1 = $sum_panjang;
      $sum_harga_1 = $sum_harga;
      $sum_bayar_1 = $sum_bayar;
      ...
      $sheet->setCellValue('E'.$new_nomering.'', $sum_panjang_1);
      $sheet->setCellValue('F'.$new_nomering.'', '');
      $sheet->setCellValue('G'.$new_nomering.'', $sum_harga_1);
      $sheet->setCellValue('H'.$new_nomering.'', $sum_bayar_1);
      $sheet->setCellValue('I'.$new_nomering.'', $print7_1);     
