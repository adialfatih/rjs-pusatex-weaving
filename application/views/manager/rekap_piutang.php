			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="card-box mb-30">
						<div class="pd-20">
							<p class="mb-0">
								<strong>Tampilkan Laporan Rekap Penjualan</strong>
          ...
          <div class="card-box mb-30">
                ...
                <?php if($tanggalRange == "yes"){
                  ...
                  if($printTanggalAkhir == $printTanggalAwal){
                    echo "Menampilkan laporan penjualan tanggal <strong>$printTanggalAwal</strong>";
                  } else {
                    echo "Menampilkan laporan penjualan dari tanggal <strong>$printTanggalAwal</strong>";
                    echo "s/d <strong>$printTanggalAkhir</strong>";
                  }
                  echo "</small>";
                } else { ?>
                <small><?="".$print_hari.", ".$print_tanggal;?></small> <?php } ?>
							</p>
