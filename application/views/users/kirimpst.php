...
<body>
    ...
    <div class="container">
        ...
        <button class="btn-save" style="background:#6e6e6e;border:1px solid #FFF;" id="btn-logout2">Terima Barang Dari Pusatex</button>
    ...
    <script>
        ...
        $( "#btn-logout2" ).on( "click", function() {
            window.location.href = "<?=base_url('users/terimafrompst');?>";
        });
