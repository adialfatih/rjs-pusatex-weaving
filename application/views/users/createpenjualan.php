...
<body>
    ...
    ?>
    <h1>Kode Paket <?=$kd;?></h1>
    <small class="sm"><?=$newToday;?>, <strong><?=$prinTgl;?></strong>, Username : <strong id="nmoptid">Nur Hikmah</strong></small><br><small class="sm">Konstruksi : <strong><?=$kons_pkg;?></strong></small><br><small class="sm">Customer : <strong><?=$cusni;?></strong></small>
    ...
    <div class="container">
        ...
        <a style="background:green;color:#FFFFFF;width:105px;display:flex;justify-content:center;align-items:center;margin-top:15px;font-size:12px;padding:5px 0;border-radius:7px;margin-left:5px;" href="<?=base_url('users/penjualan');?>">Simpan</a>
        </div>
        <br>
    ...
    <script>
        $( "#addrollLama" ).on( "click", function() {
            window.location.href = "<?=base_url('users/createpenjualan2/'.$kd);?>";
        } );
