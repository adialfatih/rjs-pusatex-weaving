...
<body>
    ...
    <?php
        ...
        $kons = $this->db->query("SELECT * FROM dt_konsumen WHERE id_konsumen IN (SELECT id_customer FROM view_nota2)");
        $ar_kons = array();
    ...
    <script>
        ...
        function loadData(tgl, kons){
            ...
            $.ajax({
                ...
                type: "POST",
                data: {"tgl" : tgl, "kons" : kons, "jns" : "All"},
                cache: false,
