						...
						<div class="pd-20">
                            <table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td>:&nbsp;</td>
                                    <th>
                                        <font style='color:red'>Pastikan PPN Ditentukan di awal pembuatan Nota.</font>
                                    </th>
                                </tr>
                                <tr>
                                    <td>7.</td>
                                    <td style="width:200px;">Presentase Tagihan</td>
                                    <td>:&nbsp;</td>
                                    <th style="display:flex;">
                                        <div style="width:250px;display:flex;flex-direction:column;">
                                            <input type="number" name="pembayaransb" value="7" max="100" min="0" class="form-control" style="width:200px;">
                                            <span style="font-size:12px;">Rekening SB %</span>
                                        </div>
                                        <div style="width:250px;display:flex;flex-direction:column;">
                                            <input type="number" name="pembayaranecer" value="64" max="100" min="0" class="form-control" style="width:200px;">
                                            <span style="font-size:12px;">Rekening Ecer (SP) %</span>
                                        </div>
                                        <div style="width:250px;display:flex;flex-direction:column;">
                                            <input type="number" name="pembayarannotad" value="29" max="100" min="0" class="form-control" style="width:200px;">
                                            <span style="font-size:12px;">Nota D (SSB) %</span>
                                        </div>
                                    </th>
                                </tr>
                            </table>
