...
<body>
    ...
    <div class="topbar">
        <?php 
            ...
            $cekkons = $this->data_model->get_byid('new_tb_packinglist', ['sha1(kode_konstruksi)'=>$kons,'lokasi_now'=>'Pusatex','siap_jual'=>'y','no_sj'=>'NULL']);
            if($cekkons->num_rows() > 0){
                echo $showKonstruksi." On Packinglist";
            } else {
                $cekkons = $this->data_model->get_byid('new_tb_packinglist', ['lokasi_now'=>'Pusatex','siap_jual'=>'y','no_sj'=>'NULL']);
