...
<head>
    ...
    <title>Produksi Inspect Finish</title>
...
<body>
    ...
    $ts = $this->db->query("SELECT id_infs,jam_input FROM `data_if` ORDER BY id_infs DESC LIMIT 1")->row("jam_input");
    $xp = explode(' ', $ts);
    $jam = explode(':', $xp[1]);
