...
<head>
    ...
    <title>Laporan Folding Finish</title>
...
<body>
    <?php
        ...
        if($cek_username->num_rows() == 1){
            $cek_ig = $this->data_model->get_byid('data_fol', ['jns_fold'=>'Finish','tgl'=>$tgl,'operator'=>$username]);
            ...
            <table id="fortable">
                ...
                if($cek_ig->num_rows() > 0){
                    ...
                    foreach($cek_ig->result() as $n => $val):
                        $total_ukuran+= floatval($val->ukuran);
                        echo "<tr>";
                        $num = $n+1;
                        echo "<td>".$num."</td>";
                ...
                <?php
                    $cek_prod = $this->data_model->get_byid('data_produksi_opt', ['username_opt'=>$username,'tgl'=>$tgl,'proses'=>'folfinish']);
                    ...
                    echo "<tr><td colspan='5'>Data Folding Grey Kosong</td></tr>";
                }
                ?>
