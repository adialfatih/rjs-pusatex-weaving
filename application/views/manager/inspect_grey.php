...
<head>
    ...
    <title>Produksi Inspect Grey</title>
...
<body>
    ...
    $ts = $this->db->query("SELECT id_data,kode_upload FROM `data_ig` ORDER BY id_data DESC LIMIT 1")->row("kode_upload");
    $xp = explode(' ', $ts);
    $jam = explode(':', $xp[1]);
    ...
    ?>
    <div class="topbar">
       Produksi Inspect Grey
    </div>
    <div style="width:100%;display:flex;justify-content:center;margin-top:-10px">
       <small><?=$printHarIni;?> - Update : <?=$ts;?></small>
    </div>
