					...
					<div class="row align-items-center">
						...
						<div class="col-md-8">
							...
							<p class="font-18 max-width-600">
								Selamat datang di sistem tracking produksi textile. Aplikasi ini secara otomatis akan menyimpan alur proses produksi di <strong>Rindang Jati Spinning</strong> dan <strong>PT. Pusatex</strong>
							</p>
						</div>
					</div>
				</div>
