    ...
    foreach($ex as $kode_roll):
        ...
        if($cari_1->num_rows() == 0){
            ...
            foreach($cari_1->result() as $val){
                ...
                echo "Inspect Grey Kode <strong>".$kode_roll."</strong> (<strong>".$val->ukuran_ori."</strong> Meter)<br>- Konstruksi <strong>".$val->konstruksi."</strong>, Nomor Mesin <strong>".$val->no_mesin."</strong>, No Beam <strong>".$val->no_beam."</strong>, Operator <strong>".$val->operator."</strong>, Tanggal Inspect <strong>".$printTgl."</strong><br>";
            }
        }
        ...
        if($cari_2->num_rows() == 0){
            ...
            foreach($cari_2->result() as $val){
                ...
                $printTgl = $tg[2]." ".$arb[$tg[1]]." ".$tg[0];
                echo "Inspect Finish Kode <strong>".$kode_roll."</strong> (<strong>".$val->ukuran_ori."</strong> Meter)<br>- Konstruksi <strong>".$val->konstruksi."</strong>, Operator <strong>".$val->operator."</strong>, Tanggal Inspect <strong>".$printTgl."</strong><br>";
            }
        }
        ...
        if($cari_3->num_rows() == 0){
            ...
            foreach($cari_3->result() as $val){
                ...
                $printTgl = $tg[2]." ".$arb[$tg[1]]." ".$tg[0];
                echo "Folding <strong>".$val->jns_fold."</strong> Kode <strong>".$kode_roll."</strong> (<strong>".$val->ukuran."</strong> ".$satuan.")<br>- Konstruksi <strong>".$val->konstruksi."</strong>, Operator <strong>".$val->operator."</strong>, Tanggal Folding <strong>".$printTgl."</strong>, (Lokasi sekarang ".$val->posisi.")<br>";
            }
        }
