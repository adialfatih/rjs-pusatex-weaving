                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$val->id_nota;?></td>
                                            <td><?=$printTglInput;?></td>
                                            <td><a href="Del" onclick="del34('<?=$val->kode_bayar;?>')" title="Hapus Pembayaran" data-toggle="modal" data-target="#Medium-modal"><i class="icon-copy fa fa-trash" style="color:red;font-size:16px;" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
