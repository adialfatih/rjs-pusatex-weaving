...
<head>
    ...
    <title>Laporan Folding Grey</title>
...
<body>
    <?php
        ...
        if($cek_username->num_rows() == 1){
            $cek_ig = $this->data_model->get_byid('data_fol', ['jns_fold'=>'Grey','tgl'=>$tgl,'operator'=>$username]);
    ...
    ?>
        ...
        <div class="fortable2">
            <table id="fortable">
                ...
                <?php
                    $cek_prod = $this->data_model->get_byid('data_produksi_opt', ['username_opt'=>$username,'tgl'=>$tgl,'proses'=>'folgrey']);
